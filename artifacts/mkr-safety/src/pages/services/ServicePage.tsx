    ...
    <Layout>
      ...
      <section className="relative py-20 bg-primary overflow-hidden">
        <div className="absolute inset-0">
          <img src={data.heroImg} alt={data.heroAlt} className="w-full h-full object-cover opacity-25" width={1200} height={600} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="space-y-4">
                {data.features.map((f) => (
                  <div key={f.title} className="border-l-2 border-secondary pl-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {data.relatedServices.map(s => (
                    <Link key={s.href} href={s.href} className="px-3 py-1.5 border border-border rounded-full text-sm text-foreground hover:border-secondary hover:text-secondary transition-all">{s.label}</Link>
                  ))}
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {data.relatedLocations.map(l => (
                    <Link key={l.href} href={l.href} className="px-3 py-1.5 border border-border rounded-full text-sm text-foreground hover:border-secondary hover:text-secondary transition-all">{l.label}</Link>
                  ))}
                </div>
              </div>
            )}
